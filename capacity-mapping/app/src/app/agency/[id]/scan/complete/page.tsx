  ...
  return (
    <main className="flex-1 flex flex-col">
      ...
      <div className="px-5 py-5 border-b border-line">
        ...
        {/* 4. drill in and correct the food, the way /scan/fix corrects the space */}
        <Link
      ...
      <div className="px-5 py-7 border-b border-line text-center">
        ...
        <p className="text-[11px] text-muted mt-4 leading-relaxed">
          Counts only space you can actually stack into, not aisles or the
          shelf nobody can reach.
        </p>
      </div>
